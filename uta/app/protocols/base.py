...
from uta.shared.ci_models import CiTaskRecord, CiTriggerRequest
...
class CiContextProvider(ABC):
    ...
    CI integrations provide issue metadata behind this interface. The generic skeleton is assembled by
    :func:`uta.app.context.assemble_base_context`; providers only decide
